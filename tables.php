		...
		if ($confirm) {
			...
			if ($attrs->recordCount() > 0) {
				...
				while (!$attrs->EOF) {
					...
					echo "<input type=\"checkbox\" checked=\"true\" name=\"show[", htmlspecialchars($attrs->fields['attname']), "]\"",
				...
				// Select all checkbox
				echo "<tr><td colspan=\"5\"><input type=\"checkbox\" checked=\"true\" id=\"selectall\" name=\"selectall\" accesskey=\"a\" onclick=\"javascript:selectAll()\" /><label for=\"selectall\">{$lang['strselectallfields']}</label></td>";
				echo "</tr></table>\n";
			}
